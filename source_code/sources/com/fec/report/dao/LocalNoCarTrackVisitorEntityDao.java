...
public class LocalNoCarTrackVisitorEntityDao extends AbstractDao<LocalNoCarTrackVisitorEntity, Long> {
    public static final String TABLENAME = "LOCAL_NO_CAR_TRACK_VISITOR_ENTITY";
    ...
    public static class Properties {
        ...
        public static final Property FkMct = new Property(2, String.class, "fkMct", false, "FK_MCT");
    ...
    public LocalNoCarTrackVisitorEntityDao(DaoConfig config) {
        super(config);
    }

    public LocalNoCarTrackVisitorEntityDao(DaoConfig config, DaoSession daoSession) {
        super(config, daoSession);
    }

    public static void createTable(Database db, boolean ifNotExists) {
        db.execSQL("CREATE TABLE " + (ifNotExists ? "IF NOT EXISTS " : "") + "\"LOCAL_NO_CAR_TRACK_VISITOR_ENTITY\" (\"LOCAL_ID\" INTEGER PRIMARY KEY AUTOINCREMENT ,\"ID\" TEXT,\"FK_MCT\" TEXT,\"NAME\" TEXT,\"ID_CARD\" TEXT,\"PHONE\" TEXT,\"ADDRESS\" TEXT,\"TYPE\" TEXT,\"CHECK_FLAG\" TEXT,\"ADD_USER\" TEXT,\"ADD_USER_NAME\" TEXT,\"ADD_TIME\" TEXT,\"USER_ORGANIZATION_ID\" TEXT,\"USER_ORG_NAME\" TEXT,\"MODIFIER\" TEXT,\"MODIFIER_NAME\" TEXT,\"MODIFY_TIME\" TEXT,\"LONGITUDE\" REAL,\"LATITUDE\" REAL,\"LOCATION_DESCRIPTION\" TEXT);");
    }

    public static void dropTable(Database db, boolean ifExists) {
        db.execSQL("DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"LOCAL_NO_CAR_TRACK_VISITOR_ENTITY\"");
    }

    protected final void bindValues(DatabaseStatement stmt, LocalNoCarTrackVisitorEntity entity) {
        stmt.clearBindings();
        ...
        String fkMct = entity.getFkMct();
        if (fkMct != null) {
            stmt.bindString(3, fkMct);
        }
    ...
    protected final void bindValues(SQLiteStatement stmt, LocalNoCarTrackVisitorEntity entity) {
        stmt.clearBindings();
        Long localID = entity.getLocalID();
        if (localID != null) {
            stmt.bindLong(1, localID.longValue());
    ...
    public LocalNoCarTrackVisitorEntity readEntity(Cursor cursor, int offset) {
        return new LocalNoCarTrackVisitorEntity(cursor.isNull(offset + 0) ? null : Long.valueOf(cursor.getLong(offset + 0)), cursor.isNull(offset + 1) ? null : cursor.getString(offset + 1), cursor.isNull(offset + 2) ? null : cursor.getString(offset + 2), cursor.isNull(offset + 3) ? null : cursor.getString(offset + 3), cursor.isNull(offset + 4) ? null : cursor.getString(offset + 4), cursor.isNull(offset + 5) ? null : cursor.getString(offset + 5), cursor.isNull(offset + 6) ? null : cursor.getString(offset + 6), cursor.isNull(offset + 7) ? null : cursor.getString(offset + 7), cursor.isNull(offset + 8) ? null : cursor.getString(offset + 8), cursor.isNull(offset + 9) ? null : cursor.getString(offset + 9), cursor.isNull(offset + 10) ? null : cursor.getString(offset + 10), cursor.isNull(offset + 11) ? null : cursor.getString(offset + 11), cursor.isNull(offset + 12) ? null : cursor.getString(offset + 12), cursor.isNull(offset + 13) ? null : cursor.getString(offset + 13), cursor.isNull(offset + 14) ? null : cursor.getString(offset + 14), cursor.isNull(offset + 15) ? null : cursor.getString(offset + 15), cursor.isNull(offset + 16) ? null : cursor.getString(offset + 16), cursor.isNull(offset + 17) ? null : Double.valueOf(cursor.getDouble(offset + 17)), cursor.isNull(offset + 18) ? null : Double.valueOf(cursor.getDouble(offset + 18)), cursor.isNull(offset + 19) ? null : cursor.getString(offset + 19));
    }

    public void readEntity(Cursor cursor, LocalNoCarTrackVisitorEntity entity, int offset) {
        String str = null;
        entity.setLocalID(cursor.isNull(offset + 0) ? null : Long.valueOf(cursor.getLong(offset + 0)));
        entity.setId(cursor.isNull(offset + 1) ? null : cursor.getString(offset + 1));
        entity.setFkMct(cursor.isNull(offset + 2) ? null : cursor.getString(offset + 2));
    ...
    protected final Long updateKeyAfterInsert(LocalNoCarTrackVisitorEntity entity, long rowId) {
        entity.setLocalID(Long.valueOf(rowId));
        return Long.valueOf(rowId);
    }

    public Long getKey(LocalNoCarTrackVisitorEntity entity) {
        if (entity != null) {
    ...
    public boolean hasKey(LocalNoCarTrackVisitorEntity entity) {
