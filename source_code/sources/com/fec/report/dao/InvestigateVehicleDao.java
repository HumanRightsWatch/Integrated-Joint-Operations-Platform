...
public class InvestigateVehicleDao extends AbstractDao<InvestigateVehicle, Long> {
    public static final String TABLENAME = "INVESTIGATE_VEHICLE";
    private Query<InvestigateVehicle> investigationInfo_InvestigateVehicleListQuery;
    ...
    public InvestigateVehicleDao(DaoConfig config) {
        super(config);
    }

    public InvestigateVehicleDao(DaoConfig config, DaoSession daoSession) {
        super(config, daoSession);
    }

    public static void createTable(Database db, boolean ifNotExists) {
        db.execSQL("CREATE TABLE " + (ifNotExists ? "IF NOT EXISTS " : "") + "\"INVESTIGATE_VEHICLE\" (\"LOCAL_ID\" INTEGER PRIMARY KEY AUTOINCREMENT ,\"ID\" TEXT,\"LOCAL_FK_IR\" INTEGER,\"PLATE_NUMBER\" TEXT,\"PHOTO\" TEXT,\"VEHICLE_COLOR\" INTEGER,\"VEHICLE_TYPE\" INTEGER,\"NOTE\" TEXT);");
    }

    public static void dropTable(Database db, boolean ifExists) {
        db.execSQL("DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"INVESTIGATE_VEHICLE\"");
    }

    protected final void bindValues(DatabaseStatement stmt, InvestigateVehicle entity) {
        stmt.clearBindings();
    ...
    protected final void bindValues(SQLiteStatement stmt, InvestigateVehicle entity) {
        stmt.clearBindings();
        Long local_id = entity.getLocal_id();
        if (local_id != null) {
            stmt.bindLong(1, local_id.longValue());
    ...
    public InvestigateVehicle readEntity(Cursor cursor, int offset) {
        String str = null;
        ...
        return new InvestigateVehicle(valueOf, string, valueOf2, string2, string3, valueOf3, valueOf4, str);
    }

    public void readEntity(Cursor cursor, InvestigateVehicle entity, int offset) {
        String str = null;
    ...
    protected final Long updateKeyAfterInsert(InvestigateVehicle entity, long rowId) {
        entity.setLocal_id(Long.valueOf(rowId));
        return Long.valueOf(rowId);
    }

    public Long getKey(InvestigateVehicle entity) {
        if (entity != null) {
    ...
    public boolean hasKey(InvestigateVehicle entity) {
    ...
    public List<InvestigateVehicle> _queryInvestigationInfo_InvestigateVehicleList(Long local_fkIr) {
        synchronized (this) {
            if (this.investigationInfo_InvestigateVehicleListQuery == null) {
                QueryBuilder<InvestigateVehicle> queryBuilder = queryBuilder();
                queryBuilder.where(Properties.Local_fkIr.eq(null), new WhereCondition[0]);
                this.investigationInfo_InvestigateVehicleListQuery = queryBuilder.build();
            }
        }
        Query<InvestigateVehicle> query = this.investigationInfo_InvestigateVehicleListQuery.forCurrentThread();
