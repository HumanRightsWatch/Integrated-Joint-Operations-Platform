...
public class ManualInfoDao extends AbstractDao<ManualInfo, Long> {
    ...
    public ManualInfoDao(DaoConfig config) {
        super(config);
    }

    public ManualInfoDao(DaoConfig config, DaoSession daoSession) {
        super(config, daoSession);
        this.daoSession = daoSession;
    }

    public static void createTable(Database db, boolean ifNotExists) {
        db.execSQL("CREATE TABLE " + (ifNotExists ? "IF NOT EXISTS " : "") + "\"MANUAL_INFO\" (\"LOCAL_ID\" INTEGER PRIMARY KEY AUTOINCREMENT ,\"ID\" TEXT,\"FK_II\" TEXT,\"INFO_TYPE\" TEXT,\"DESCRIPTION\" TEXT,\"NAME\" TEXT,\"ID_CARD\" TEXT,\"PHONE\" TEXT,\"PASSPORT\" TEXT,\"WORK\" TEXT,\"WORK_UNIT\" TEXT,\"ADDRESS\" TEXT,\"PHOTO\" TEXT,\"RESPONSE\" TEXT,\"POLICE_CHECK\" INTEGER,\"IS_PUSHED\" INTEGER,\"NOTE\" TEXT,\"POLICE_REASON\" TEXT,\"LATITUDE\" TEXT,\"LONGITUDE\" TEXT);");
    }

    public static void dropTable(Database db, boolean ifExists) {
        db.execSQL("DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"MANUAL_INFO\"");
    }

    protected final void bindValues(DatabaseStatement stmt, ManualInfo entity) {
        stmt.clearBindings();
    ...
    protected final void bindValues(SQLiteStatement stmt, ManualInfo entity) {
        stmt.clearBindings();
        Long local_id = entity.getLocal_id();
        if (local_id != null) {
            stmt.bindLong(1, local_id.longValue());
    ...
    protected final void attachEntity(ManualInfo entity) {
    ...
    public ManualInfo readEntity(Cursor cursor, int offset) {
        return new ManualInfo(cursor.isNull(offset + 0) ? null : Long.valueOf(cursor.getLong(offset + 0)), cursor.isNull(offset + 1) ? null : cursor.getString(offset + 1), cursor.isNull(offset + 2) ? null : cursor.getString(offset + 2), cursor.isNull(offset + 3) ? null : cursor.getString(offset + 3), cursor.isNull(offset + 4) ? null : cursor.getString(offset + 4), cursor.isNull(offset + 5) ? null : cursor.getString(offset + 5), cursor.isNull(offset + 6) ? null : cursor.getString(offset + 6), cursor.isNull(offset + 7) ? null : cursor.getString(offset + 7), cursor.isNull(offset + 8) ? null : cursor.getString(offset + 8), cursor.isNull(offset + 9) ? null : cursor.getString(offset + 9), cursor.isNull(offset + 10) ? null : cursor.getString(offset + 10), cursor.isNull(offset + 11) ? null : cursor.getString(offset + 11), cursor.isNull(offset + 12) ? null : cursor.getString(offset + 12), cursor.isNull(offset + 13) ? null : cursor.getString(offset + 13), cursor.isNull(offset + 14) ? null : Integer.valueOf(cursor.getInt(offset + 14)), cursor.isNull(offset + 15) ? null : Integer.valueOf(cursor.getInt(offset + 15)), cursor.isNull(offset + 16) ? null : cursor.getString(offset + 16), cursor.isNull(offset + 17) ? null : cursor.getString(offset + 17), cursor.isNull(offset + 18) ? null : cursor.getString(offset + 18), cursor.isNull(offset + 19) ? null : cursor.getString(offset + 19));
    }

    public void readEntity(Cursor cursor, ManualInfo entity, int offset) {
        String str = null;
    ...
    protected final Long updateKeyAfterInsert(ManualInfo entity, long rowId) {
        entity.setLocal_id(Long.valueOf(rowId));
        return Long.valueOf(rowId);
    }

    public Long getKey(ManualInfo entity) {
        if (entity != null) {
    ...
    public boolean hasKey(ManualInfo entity) {
