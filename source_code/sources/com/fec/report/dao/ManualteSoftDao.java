...
public class ManualteSoftDao extends AbstractDao<ManualteSoft, Long> {
    public static final String TABLENAME = "MANUALTE_SOFT";
    private Query<ManualteSoft> manualInfo_ManualteSoftListQuery;
    ...
    public ManualteSoftDao(DaoConfig config) {
        super(config);
    }

    public ManualteSoftDao(DaoConfig config, DaoSession daoSession) {
        super(config, daoSession);
    }

    public static void createTable(Database db, boolean ifNotExists) {
        db.execSQL("CREATE TABLE " + (ifNotExists ? "IF NOT EXISTS " : "") + "\"MANUALTE_SOFT\" (\"LOCAL_ID\" INTEGER PRIMARY KEY AUTOINCREMENT ,\"ID\" TEXT,\"LOCAL_FK_IR\" INTEGER,\"FK_SDIC\" INTEGER,\"ACCOUNT\" TEXT,\"NOTE\" TEXT);");
    }

    public static void dropTable(Database db, boolean ifExists) {
        db.execSQL("DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"MANUALTE_SOFT\"");
    }

    protected final void bindValues(DatabaseStatement stmt, ManualteSoft entity) {
        stmt.clearBindings();
    ...
    protected final void bindValues(SQLiteStatement stmt, ManualteSoft entity) {
        stmt.clearBindings();
        Long local_id = entity.getLocal_id();
        if (local_id != null) {
            stmt.bindLong(1, local_id.longValue());
    ...
    public ManualteSoft readEntity(Cursor cursor, int offset) {
        String str = null;
        ...
        return new ManualteSoft(valueOf, string, valueOf2, valueOf3, string2, str);
    }

    public void readEntity(Cursor cursor, ManualteSoft entity, int offset) {
        String str = null;
    ...
    protected final Long updateKeyAfterInsert(ManualteSoft entity, long rowId) {
        entity.setLocal_id(Long.valueOf(rowId));
        return Long.valueOf(rowId);
    }

    public Long getKey(ManualteSoft entity) {
        if (entity != null) {
    ...
    public boolean hasKey(ManualteSoft entity) {
    ...
    public List<ManualteSoft> _queryManualInfo_ManualteSoftList(Long local_fkIr) {
        synchronized (this) {
            if (this.manualInfo_ManualteSoftListQuery == null) {
                QueryBuilder<ManualteSoft> queryBuilder = queryBuilder();
                queryBuilder.where(Properties.Local_fkIr.eq(null), new WhereCondition[0]);
                this.manualInfo_ManualteSoftListQuery = queryBuilder.build();
            }
        }
        Query<ManualteSoft> query = this.manualInfo_ManualteSoftListQuery.forCurrentThread();
