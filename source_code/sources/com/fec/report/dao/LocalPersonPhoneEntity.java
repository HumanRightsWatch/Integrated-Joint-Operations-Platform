...
public class LocalPersonPhoneEntity {
    ...
    public LocalPersonPhoneEntity(Long localID) {
        this.localID = localID;
    }

    public LocalPersonPhoneEntity(Long localID, String id, String dataId, String index, String phoneNumber, String idCard, String districtAreaCode, String permanentAddress, String businessTime, String name, String pushTime, String description, Integer isChecked, String fkCm, String sendTime, String feedbackTime, String policeCheck, String note, String addUser, String addUserName, String addTime, String userOrganizationId, String userOrgName, String modifier, String modifierName, String modifyTime, Integer isLogicDelete) {
        this.localID = localID;
        this.id = id;
        this.dataId = dataId;
        this.index = index;
