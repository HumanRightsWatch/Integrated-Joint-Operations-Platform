...
public class IllegalCarDao extends AbstractDao<IllegalCar, Long> {
    public static final String TABLENAME = "ILLEGAL_CAR";
    ...
    public IllegalCarDao(DaoConfig config) {
        super(config);
    }

    public IllegalCarDao(DaoConfig config, DaoSession daoSession) {
        super(config, daoSession);
    }

    public static void createTable(Database db, boolean ifNotExists) {
        db.execSQL("CREATE TABLE " + (ifNotExists ? "IF NOT EXISTS " : "") + "\"ILLEGAL_CAR\" (\"_id\" INTEGER PRIMARY KEY AUTOINCREMENT ,\"TYPE\" INTEGER,\"CONTENT\" TEXT,\"ADDRESS\" TEXT,\"SUBMIT_LATITUDE\" TEXT,\"SUBMIT_LONGITUDE\" TEXT,\"VOICE\" TEXT,\"PICTURE\" TEXT,\"IS_SEND\" TEXT,\"IDENTITY\" TEXT,\"RELATIVE_PERSON\" TEXT,\"RELATIVE_THING\" TEXT,\"URGENCY\" INTEGER,\"SUBMITER\" TEXT,\"VIDEO\" TEXT,\"NOTE\" TEXT,\"SUBMIT_TIME\" TEXT,\"SUBMITER_UCID\" TEXT);");
    }

    public static void dropTable(Database db, boolean ifExists) {
        db.execSQL("DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"ILLEGAL_CAR\"");
    }

    protected final void bindValues(DatabaseStatement stmt, IllegalCar entity) {
        stmt.clearBindings();
    ...
    protected final void bindValues(SQLiteStatement stmt, IllegalCar entity) {
        stmt.clearBindings();
        Long id = entity.getId();
        if (id != null) {
            stmt.bindLong(1, id.longValue());
    ...
    public IllegalCar readEntity(Cursor cursor, int offset) {
        return new IllegalCar(cursor.isNull(offset + 0) ? null : Long.valueOf(cursor.getLong(offset + 0)), cursor.isNull(offset + 1) ? null : Integer.valueOf(cursor.getInt(offset + 1)), cursor.isNull(offset + 2) ? null : cursor.getString(offset + 2), cursor.isNull(offset + 3) ? null : cursor.getString(offset + 3), cursor.isNull(offset + 4) ? null : cursor.getString(offset + 4), cursor.isNull(offset + 5) ? null : cursor.getString(offset + 5), cursor.isNull(offset + 6) ? null : cursor.getString(offset + 6), cursor.isNull(offset + 7) ? null : cursor.getString(offset + 7), cursor.isNull(offset + 8) ? null : cursor.getString(offset + 8), cursor.isNull(offset + 9) ? null : cursor.getString(offset + 9), cursor.isNull(offset + 10) ? null : cursor.getString(offset + 10), cursor.isNull(offset + 11) ? null : cursor.getString(offset + 11), cursor.isNull(offset + 12) ? null : Integer.valueOf(cursor.getInt(offset + 12)), cursor.isNull(offset + 13) ? null : cursor.getString(offset + 13), cursor.isNull(offset + 14) ? null : cursor.getString(offset + 14), cursor.isNull(offset + 15) ? null : cursor.getString(offset + 15), cursor.isNull(offset + 16) ? null : cursor.getString(offset + 16), cursor.isNull(offset + 17) ? null : cursor.getString(offset + 17));
    }

    public void readEntity(Cursor cursor, IllegalCar entity, int offset) {
        String str = null;
        ...
        entity.setSubmiterUCId(str);
    }

    protected final Long updateKeyAfterInsert(IllegalCar entity, long rowId) {
        entity.setId(Long.valueOf(rowId));
        return Long.valueOf(rowId);
    }

    public Long getKey(IllegalCar entity) {
        if (entity != null) {
            return entity.getId();
        }
        return null;
    ...
    public boolean hasKey(IllegalCar entity) {
