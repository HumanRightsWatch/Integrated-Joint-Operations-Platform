...
public class IllegalThing {
    ...
    public IllegalThing(Long id) {
        this.id = id;
    }

    public IllegalThing(Long id, Integer type, String content, String address, String submitLatitude, String submitLongitude, String voice, String picture, String isSend, String identity, String relativePerson, String relativeThing, Integer urgency, String submiter, String video, String note, String submitTime, String submiterUCId, String objectName, String objectIdentifier) {
        this.id = id;
        this.type = type;
