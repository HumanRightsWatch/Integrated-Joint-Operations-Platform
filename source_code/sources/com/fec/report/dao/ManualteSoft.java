...
public class ManualteSoft {
    ...
    public ManualteSoft(Long local_id) {
        this.local_id = local_id;
    }

    public ManualteSoft(Long local_id, String id, Long local_fkIr, Integer fkSDic, String account, String note) {
        this.local_id = local_id;
        this.id = id;
