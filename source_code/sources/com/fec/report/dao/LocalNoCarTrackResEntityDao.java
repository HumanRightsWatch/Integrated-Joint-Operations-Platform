...
public class LocalNoCarTrackResEntityDao extends AbstractDao<LocalNoCarTrackResEntity, Long> {
    public static final String TABLENAME = "LOCAL_NO_CAR_TRACK_RES_ENTITY";
    ...
    public static class Properties {
        ...
        public static final Property Expression = new Property(8, Integer.class, "expression", false, "EXPRESSION");
        public static final Property ExpressionDesc = new Property(9, String.class, "expressionDesc", false, "EXPRESSION_DESC");
        public static final Property FkMctv = new Property(3, String.class, "fkMctv", false, "FK_MCTV");
        public static final Property Id = new Property(1, String.class, "id", false, "ID");
        public static final Property Latitude = new Property(22, Double.class, "latitude", false, "LATITUDE");
        public static final Property LocalFkMctv = new Property(2, Long.class, "localFkMctv", false, "LOCAL_FK_MCTV");
    ...
    public LocalNoCarTrackResEntityDao(DaoConfig config) {
        super(config);
    }

    public LocalNoCarTrackResEntityDao(DaoConfig config, DaoSession daoSession) {
        super(config, daoSession);
    }

    public static void createTable(Database db, boolean ifNotExists) {
        db.execSQL("CREATE TABLE " + (ifNotExists ? "IF NOT EXISTS " : "") + "\"LOCAL_NO_CAR_TRACK_RES_ENTITY\" (\"LOCAL_ID\" INTEGER PRIMARY KEY AUTOINCREMENT ,\"ID\" TEXT,\"LOCAL_FK_MCTV\" INTEGER,\"FK_MCTV\" TEXT,\"RELATIONSHIP\" INTEGER,\"MISS_TRAIL_REASON\" INTEGER,\"OTHER_REASON\" TEXT,\"TEL_NUMBER\" TEXT,\"EXPRESSION\" INTEGER,\"EXPRESSION_DESC\" TEXT,\"POLICE_CHECK\" TEXT,\"POLICE_REASON\" TEXT,\"NOTE\" TEXT,\"ADD_USER\" TEXT,\"ADD_USER_NAME\" TEXT,\"ADD_TIME\" TEXT,\"USER_ORGANIZATION_ID\" TEXT,\"USER_ORG_NAME\" TEXT,\"MODIFIER\" TEXT,\"MODIFIER_NAME\" TEXT,\"MODIFY_TIME\" TEXT,\"LONGITUDE\" REAL,\"LATITUDE\" REAL,\"LOCATION_DESCRIPTION\" TEXT);");
    }

    public static void dropTable(Database db, boolean ifExists) {
        db.execSQL("DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"LOCAL_NO_CAR_TRACK_RES_ENTITY\"");
    }

    protected final void bindValues(DatabaseStatement stmt, LocalNoCarTrackResEntity entity) {
        stmt.clearBindings();
        ...
        Long localFkMctv = entity.getLocalFkMctv();
        if (localFkMctv != null) {
            stmt.bindLong(3, localFkMctv.longValue());
        }
        String fkMctv = entity.getFkMctv();
        if (fkMctv != null) {
            stmt.bindString(4, fkMctv);
        }
        ...
        if (expression != null) {
            stmt.bindLong(9, (long) expression.intValue());
        }
        String expressionDesc = entity.getExpressionDesc();
        if (expressionDesc != null) {
            stmt.bindString(10, expressionDesc);
        }
    ...
    protected final void bindValues(SQLiteStatement stmt, LocalNoCarTrackResEntity entity) {
        stmt.clearBindings();
        Long localID = entity.getLocalID();
        if (localID != null) {
            stmt.bindLong(1, localID.longValue());
    ...
    public LocalNoCarTrackResEntity readEntity(Cursor cursor, int offset) {
        return new LocalNoCarTrackResEntity(cursor.isNull(offset + 0) ? null : Long.valueOf(cursor.getLong(offset + 0)), cursor.isNull(offset + 1) ? null : cursor.getString(offset + 1), cursor.isNull(offset + 2) ? null : Long.valueOf(cursor.getLong(offset + 2)), cursor.isNull(offset + 3) ? null : cursor.getString(offset + 3), cursor.isNull(offset + 4) ? null : Integer.valueOf(cursor.getInt(offset + 4)), cursor.isNull(offset + 5) ? null : Integer.valueOf(cursor.getInt(offset + 5)), cursor.isNull(offset + 6) ? null : cursor.getString(offset + 6), cursor.isNull(offset + 7) ? null : cursor.getString(offset + 7), cursor.isNull(offset + 8) ? null : Integer.valueOf(cursor.getInt(offset + 8)), cursor.isNull(offset + 9) ? null : cursor.getString(offset + 9), cursor.isNull(offset + 10) ? null : cursor.getString(offset + 10), cursor.isNull(offset + 11) ? null : cursor.getString(offset + 11), cursor.isNull(offset + 12) ? null : cursor.getString(offset + 12), cursor.isNull(offset + 13) ? null : cursor.getString(offset + 13), cursor.isNull(offset + 14) ? null : cursor.getString(offset + 14), cursor.isNull(offset + 15) ? null : cursor.getString(offset + 15), cursor.isNull(offset + 16) ? null : cursor.getString(offset + 16), cursor.isNull(offset + 17) ? null : cursor.getString(offset + 17), cursor.isNull(offset + 18) ? null : cursor.getString(offset + 18), cursor.isNull(offset + 19) ? null : cursor.getString(offset + 19), cursor.isNull(offset + 20) ? null : cursor.getString(offset + 20), cursor.isNull(offset + 21) ? null : Double.valueOf(cursor.getDouble(offset + 21)), cursor.isNull(offset + 22) ? null : Double.valueOf(cursor.getDouble(offset + 22)), cursor.isNull(offset + 23) ? null : cursor.getString(offset + 23));
    }

    public void readEntity(Cursor cursor, LocalNoCarTrackResEntity entity, int offset) {
        String str = null;
        entity.setLocalID(cursor.isNull(offset + 0) ? null : Long.valueOf(cursor.getLong(offset + 0)));
        entity.setId(cursor.isNull(offset + 1) ? null : cursor.getString(offset + 1));
        entity.setLocalFkMctv(cursor.isNull(offset + 2) ? null : Long.valueOf(cursor.getLong(offset + 2)));
        entity.setFkMctv(cursor.isNull(offset + 3) ? null : cursor.getString(offset + 3));
        ...
        entity.setExpression(cursor.isNull(offset + 8) ? null : Integer.valueOf(cursor.getInt(offset + 8)));
        entity.setExpressionDesc(cursor.isNull(offset + 9) ? null : cursor.getString(offset + 9));
    ...
    protected final Long updateKeyAfterInsert(LocalNoCarTrackResEntity entity, long rowId) {
        entity.setLocalID(Long.valueOf(rowId));
        return Long.valueOf(rowId);
    }

    public Long getKey(LocalNoCarTrackResEntity entity) {
        if (entity != null) {
    ...
    public boolean hasKey(LocalNoCarTrackResEntity entity) {
