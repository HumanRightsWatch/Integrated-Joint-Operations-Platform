...
public class ManualVehicle {
    ...
    public ManualVehicle(Long local_id) {
        this.local_id = local_id;
    }

    public ManualVehicle(Long local_id, String id, Long local_fkIr, String plateNumber, String photo, Integer vehicleColor, Integer vehicleType, String note) {
        this.local_id = local_id;
        this.id = id;
